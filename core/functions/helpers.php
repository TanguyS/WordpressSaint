...
function get_view($view, $object = array()) {
	global $_args; 

	$_args = $object;

	get_template_part( 'core/views/' . $view );
}

function get_partial($partial, $object = array(), $stack = 'global') {
	global $_data; 
	...
	get_template_part( 'core/partials/' . $stack . '_' . $partial );
}
